...
# Create frequency table for the three groups
...
both_periods = pd.merge(
    df_early[["word", "Early"]], df_late[["word", "Late"]], on="word", how="outer"
).fillna(0)

df_freq_periods = pd.merge(
    both_periods, df_shk[["word", "Shakespeare"]], on="word", how="outer"
).fillna(0)
